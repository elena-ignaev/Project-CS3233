...
public class History {
    ...
    public void loadCationDB(String filename) {
        try {
            ...
            while ((line = bf.readLine()) != null) {
                ...
                Cation cation = new Cation(tokenizer[0], Integer.parseInt(tokenizer[1]), tokenizer[2], tokenizer[3]);
    ...
    public void loadAnionDB(String filename) {
        try {
            ...
            while((line = bf.readLine()) != null) {
                String[] tokenizer = line.split(",");
                Anion anion = new Anion(tokenizer[0], Integer.parseInt(tokenizer[1]), tokenizer[2], tokenizer[3]);
